public class Team8SortCompetition extends SortCompetition {
    ...
    private void challengeFiveQuickSort(Comparable[] arr) {
        challengeFiveQuickSort(arr, 0, arr.length - 1);
    }

    static void challengeFiveQuickSort(Comparable[] arr, int left, int right) {
        if (left < right) {
    ...
    private static int challengeFivePartition(Comparable[] arr, int left, int right) {
